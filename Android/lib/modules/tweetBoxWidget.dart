          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  CircleAvatar(backgroundImage: NetworkImage('https://abs.twimg.com/sticky/default_profile_images/default_profile_400x400.png'), radius: 20,),
                  SizedBox(width: 5,),
                  Text("${val.username} ", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                  Text("${val.twitterHandle} . ", style: TextStyle(fontSize: 18),),
                  Text("${val.time}", style: TextStyle(fontSize: 17),),
                ],),
            ),
            Row(
              mainAxisAlignment : MainAxisAlignment.start,
                ...
                children: [
                  ...
                  InkWell(
                    child: Text.rich(
                        TextSpan(children: [
                          WidgetSpan(
                              child:isLiked? FaIcon(FontAwesomeIcons.solidHeart,size: 17, color: Colors.redAccent,) : FaIcon(FontAwesomeIcons.heart,size: 17,)),
                          TextSpan(text: "  724")])),
                    onTap: function,)
                ])
          ],
