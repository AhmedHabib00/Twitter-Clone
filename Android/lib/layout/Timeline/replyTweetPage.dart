...
class replyTweetPage extends StatefulWidget {
  String token;
  String tweetId;
  replyTweetPage({Key? key, required this.token, required this.tweetId})
      : super(key: key);
  @override
  _replyTweetPage createState() => _replyTweetPage();
}

class _replyTweetPage extends State<replyTweetPage> {
  File? image;
  File? camera;
  GiphyGif? gifs;
  late String gifsUrl = '';
