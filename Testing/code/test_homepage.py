...
def sign_in():
    ...
    try:
        driver.find_element(By.ID, accessabilities.sign_in_password_textbox_id).send_keys(accessabilities.password)
    except NoSuchElementException:
        pass
...
def test_tweetbox_text_image_combinations_1():
    # SIGN IN
    driver = sign_in()
...
def test_tweetbox_text_image_combinations_2():
    # SIGN IN
    driver = sign_in()
    # case 3
    try:
...
def test_tweetbox_text_image_combinations_3():
    # case 7
    # UPLOAD 5 IMAGES
    driver = image_exceeding_limit()
        ...
        if skip is False:
            ...
            try:
                test = (driver.find_element(By.CSS_SELECTOR,
                    ...
                    By.CSS_SELECTOR, accessabilities.image_4_css_selector).is_displayed() and not driver.find_element(
...
def test_tweetbox_text_image_combinations_4():
    # case 8
    # UPLOAD 5 IMAGES
    driver = image_exceeding_limit()
...
def test_tweetbox_text_image_combinations_5():
    # case 9
    # UPLOAD 5 IMAGES
    driver = image_exceeding_limit()
