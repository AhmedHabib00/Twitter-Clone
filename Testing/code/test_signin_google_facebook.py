...
def test_signup_google():
    ...
    try:
        ...
        driver.find_element(By.XPATH, accessabilities.google_password).send_keys(accessabilities.testing_google_password)
    except NoSuchElementException:
        pass
    ...
    test=False
    try:
        test=(driver.find_element(By.XPATH, accessabilities.home_page).is_displayed())
    except NoSuchElementException:
        pass

    print('VALID SIGN IN WITH GOOGLE')
...
def test_signup_facebook():
    ...
    print('VALID SIGN IN WITH FACEBOOK')
