...
info_username = 'username-info'
info_usernamebox = 'username-changebox'
info_username_error = 'username-error'
info_save_changes = 'info-save-changes'
info_gender = 'gender'
info_gender_male = 'gender-male'
info_usernameofprofile = 'current-username'
...
reply_text_box_id = 'twbox-text-area-reply'
whisper_reply_button_id = 'twbox-submit'
close_button = '#popup-page-children > svg'
